"""Apertus CCE patch. Apertus inherits Llama. Adapted from transformers 5.15."""
...
def patch_apertus(
    ...
    modeling_apertus.ApertusForCausalLM.forward = cce_forward
    return None
