...
def _get_patch_fn(model_type: str):
    ...
    Backward compatible: if PATCH_FNS[model_type] is already a function
    (old API / already imported), return it directly. If it's a tuple
    (new API), lazy import it.
    """
    ...
    # Backward compatibility: if already a function, return directly
